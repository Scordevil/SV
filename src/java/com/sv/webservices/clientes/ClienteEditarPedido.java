...
public class ClienteEditarPedido {
     ...
     */
    public <T> T editarPedido(Class<T> responseType, String idInventario, String idPedido) throws ClientErrorException {
        String[] queryParamNames = new String[]{"idInventario", "idPedido"};
        String[] queryParamValues = new String[]{idInventario, idPedido};
        ;
